                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="alert alert-dark text-center" role="alert">
                                    Filtrar por Tipo:
                                    <a href="index.php" class="alert-link">Todos</a> | 
                                    <a href="index.php?q=6" class="alert-link">Aquario</a> |
                                    <a href="index.php?q=10" class="alert-link">Cinema</a> |
                                    <a href="index.php?q=9" class="alert-link">Local</a> |
                                    <a href="index.php?q=3" class="alert-link">Marco</a> | 
                                    <a href="index.php?q=5" class="alert-link">Teatro</a>
                                </div>
                            </div>
                            <div class="col-md-10 offset-md-1">
                                ...
                                echo "
                                    ...
                                    <div class='row'>
                                        <div class='col-md-3 offset-md-1'>
                                            <a href='showatrativo.php?id=" . $r[idlocal] . "&nm=" . $r[nmlocal] . "'>
