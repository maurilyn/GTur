                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="alert alert-dark text-center" role="alert">
                                    Filtrar por acesso:
                                    <a href="index.php" class="alert-link">Todas</a> | 
                                    <a href="index.php?q=livre" class="alert-link">Livre</a> | 
                                    <a href="index.php?q=restrito" class="alert-link">Restrito</a> | 
                                    <a href="index.php?q=trilha" class="alert-link">Trilha</a>
                                </div>
                            </div>
                            <div class="col-md-10 offset-md-1">
                                ...
                                echo "
                                    ...
                                    <div class='row'>
                                        <div class='col-md-3 offset-md-1'>
                                            <a href='showpraia.php?id=" . $r[idlocal] . "&nm=" . $r[nmlocal] . "'>
